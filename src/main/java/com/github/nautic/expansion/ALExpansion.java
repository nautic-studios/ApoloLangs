...
public class ALExpansion extends PlaceholderExpansion {
    ...
    public ALExpansion(ApoloLangs plugin) {
        this.plugin = plugin;
    }
    ...
    public @Nullable String onPlaceholderRequest(Player player, @NotNull String params) {
        ...
        try {
            if (!params.contains(")_(")) {
                return ColorUtils.Set(langHandler.getSystemMessage(userLang, "invalid_placeholder_format"));
            }
            ...
            if (result == null || result.isEmpty()) {
                return ColorUtils.Set(langHandler.getSystemMessage(userLang, "not_found_path"));
            }

            return ColorUtils.Set(result);
        } catch (Exception e) {
            return ColorUtils.Set(langHandler.getSystemMessage(userLang, "invalid_lang_format"));
        }
    }
}
