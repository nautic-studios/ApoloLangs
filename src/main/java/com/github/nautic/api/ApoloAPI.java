...
public final class ApoloAPI {
    ...
    private static ApoloAPI instance;

    private final LangHandler langHandler;
    private final LanguageManager languageManager;

    private ApoloAPI(LangHandler langHandler, LanguageManager languageManager) {
        this.langHandler = langHandler;
        this.languageManager = languageManager;
    }

    public static void initialize(ApoloLangs plugin) {
        if (instance != null) return;
        instance = new ApoloAPI(
    ...
    public static String get(String langInput, String path) {
        ...
        return get().langHandler.get(resolved, resolved, path);
    }
